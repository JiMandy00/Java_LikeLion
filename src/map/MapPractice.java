...
public class MapPractice {
    public static void main(String[] args) {
        ...
        // map.keySet()이 map의 key값을 차례로 불러오는 것
        // key값. 즉, 이름을 차례로 s에 넣어라
        for (String s : map.keySet()) {
            // map.get(key)으로 해당 key에 일치하는 value를 가져온다.
            System.out.println(s + "의 깃주소 : " + map.get(s));
        }
